...
bin/cRace: bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/JoinPolicy.o bin/SelectionPolicy.o bin/Simulation.o
	g++ -o bin/cRace bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/JoinPolicy.o bin/SelectionPolicy.o bin/Simulation.o
